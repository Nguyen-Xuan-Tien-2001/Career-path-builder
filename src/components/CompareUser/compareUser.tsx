              ...
              <Row gutter={[16, 0]}>
                  ...
                  <Row>
                    ...
                    >
                      <Select
                        ...
                        style={{ width: 200 }}
                        value={selectedValuesReview}
                        options={dataReview?.data?.map((v: any) => ({
                          label: v.reviewname,
                          value: v.reviewid,
                        }))}
                ...
                <Col xl={10} lg={6} md={8} sm={12} xs={24}>
                  <Row>
                    ...
                    >
                      <Select
                        placeholder="Chọn nhân viên cần so sánh"
        ...
        {dataCompareUser?.status === "success" ? (
          <div className="compare-user">
            ...
            <div className="convert">
              <Button
                type="primary"
                onClick={() => setCheckedCompare(true)}
                style={{ marginRight: 10 }}
              >
                Dạng bảng <TableOutlined />
              </Button>
              <Button
                type="primary"
                onClick={() => setCheckedCompare(false)}
                danger
              >
                Dạng biểu đồ <LineChartOutlined />
              </Button>
            </div>
            {checkedCompare ? (
              <Row>
                <Col xl={8} lg={8} md={8} sm={12} xs={24}>
                  <div className="information-frame">
                    <div className="userid-name">User - Họ tên nhân viên</div>
                    <div className="userid-name">Chức vụ</div>
                    <div className="userid-name underlined">Phòng ban</div>
                    <div className="Criteria">Engagement Level</div>
                    <div className="Criteria">
                      Algorithm/ Architecture level
                    </div>
                    <div className="Criteria">Making product level</div>
                    <div className="Criteria">
                      Operation Responsibility level
                    </div>
                    <div className="Criteria">Improvement level</div>
                    <div className="Criteria">Project</div>
                  </div>
                </Col>
                <Col xl={8} lg={8} md={8} sm={12} xs={24}>
                  <div className="information-frame">
